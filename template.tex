...
\institute[ISEE]{\normalsize 
		\includegraphics[width=0.2\textwidth]{ZJU_BLUE.pdf}  \\
...
\begin{frame}[allowframebreaks]
	\ftitle{Bibliography}
	中文内容显示
	The not so short introduction to LATEX2$\varepsilon$ \cite{knuth1984texbook} \\
	~\\
	The texbook \cite{oetiker1995not}
    \label{Reference}
